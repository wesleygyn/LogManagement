...
namespace LogManagement.Controllers
{
    ...
    public class IdentityController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            //{
            //    const string sql = "SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'EMPRESAS'";
            //    var json = await sqlConnection.QuerySingleOrDefaultAsync<int>(sql);
            //}
